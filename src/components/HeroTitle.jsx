...
export function HeroTitle() {
  ...
  return (
    <div className='absolute flex h-full w-full flex-col items-center justify-center'>
      <div>
        <h1
          className='h-[1em] animate-textFloat bg-gradient-to-br from-emerald-400 to-sky-500 bg-clip-text font-montserrat text-[10vw] font-extrabold leading-none text-transparent drop-shadow-2xl sm:text-[11vw]'
          style={{
